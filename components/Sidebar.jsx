...
const Sidebar = () => {
  ...
  return (
    <div className="text-gray-500 p-5 text-xs lg:text-sm overflow-y-scroll sm:max-w-[12rem] lg:max-w-[15rem] scrollbar-hide hidden  h-screen md:inline-flex border-r border-gray-900 pb-36">
