...
const Track = ({ track, chooseTrack  }) => {
  ...
  return (
    <div className="grid grid-cols-2 cursor-default hover:bg-white/10 py-2 px-4 rounded-lg group transition ease-out">
      <div className="flex items-center">
        <img
          src={track.albumUrl}
          alt=""
          className="hidden md:rounded-xl h-12 w-12 object-cover mr-3"
        />
        <div>
      ...
      <div className="md:ml-auto flex items-center space-x-2.5 ml-11">
        <div className="hidden md:flex text-white space-x-1 text-sm font-semibold">
